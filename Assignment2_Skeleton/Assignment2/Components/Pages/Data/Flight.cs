...
namespace Assignment2.Components.Pages.Data
{
    internal class Flight
    {
        ...
        {
            //if the from and to airport is start with Y, it means it is a domestic flight
        ...
        //check code is valid and match is with certain airlines
        private void ParseCode(string code) //throws InvalidFlightCodeException
        {
            ...
            switch (abbreviation)
            {
                ...
                case "VA":
                    ...
                    break;
                //if the code does not match any options above, it will execute default
                default:
                    throw new Exception();//InvalidFlightCodeException
            }
        }
